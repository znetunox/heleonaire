...
export function calcMatk(int_, staffMatk) {
...
export function calcAspd(baseAspd, agi, dex) {
 ...
 */
export function calcCastTime(baseCastMs, dex, int_) {
...
export function calcPhysicalDamage(atkTotal, targetDef, critRoll, critMultiplier = 1.4) {
...
export function calcMagicalDamage(matkMin, matkMax, targetMdef) {
 ...
 */
export function calcExpPenalty(playerLevel, mobLevel) {
 ...
 */
export function rollDrop(rate, luk = 0) {
