...
import { importRefineData } from "./refineImporter";
async function main() {
    ...
    try {
        ...
        if (items.failed > 0) {
            console.error("[rAthena] Item import failed. Aborting before mobs/drops.");
            process.exitCode = 1;
            return;
        }
        // ============================================================
        // 2. REFINE
        // ============================================================
        console.log("[2/4] Importing refine data...");
        await importRefineData();
        // ============================================================
        // 2. MOBS
        // ============================================================
        console.log("[3/4] Importing mobs...");
        const mobs = await importMobs();
        if (mobs.failed > 0) {
            console.error("[rAthena] Mob import failed. Aborting before drops.");
            process.exitCode = 1;
            return;
        }
        // ============================================================
        // 3. DROPS
        // ============================================================
        console.log("[4/4] Importing drops...");
