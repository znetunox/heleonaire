import { calculateAttackerCardfix, calculateDefenderCardfix, } from "./cardfixCalculator";
// ============================================================================
...
(() => {
    ...
    if (result.weaponAtk !== 90 || result.equipAtk !== 90) {
        throw new Error(`Race atacante failed: expected 90, got weaponAtk=${result.weaponAtk}, equipAtk=${result.equipAtk}`);
    }
...
(() => {
    ...
    if (result.weaponAtk !== 90 || result.equipAtk !== 90) {
        throw new Error(`Element atacante failed: expected 90, got weaponAtk=${result.weaponAtk}, equipAtk=${result.equipAtk}`);
    }
...
(() => {
    ...
    if (result.weaponAtk !== 90 || result.equipAtk !== 90) {
        throw new Error(`Size atacante failed: expected 90, got weaponAtk=${result.weaponAtk}, equipAtk=${result.equipAtk}`);
    }
...
(() => {
    ...
    if (result.weaponAtk !== 73 || result.equipAtk !== 73) {
        throw new Error(`Race2 atacante failed: expected 73, got weaponAtk=${result.weaponAtk}, equipAtk=${result.equipAtk}`);
    }
...
(() => {
    ...
    if (result.weaponAtk !== 90 || result.equipAtk !== 90) {
        throw new Error(`Class atacante failed: expected 90, got weaponAtk=${result.weaponAtk}, equipAtk=${result.equipAtk}`);
    }
...
(() => {
    ...
    if (result.weaponAtk !== 75 || result.equipAtk !== 75) {
        throw new Error(`Ordem atacante failed: expected 75, got weaponAtk=${result.weaponAtk}, equipAtk=${result.equipAtk}`);
    }
...
(() => {
    ...
    if (result.weaponAtk !== 75 || result.equipAtk !== 75) {
        throw new Error(`Truncamento atacante failed: expected 75, got weaponAtk=${result.weaponAtk}, equipAtk=${result.equipAtk}`);
    }
...
(() => {
    ...
    if (result.weaponAtk !== 110 || result.equipAtk !== 55) {
        throw new Error(`Preservação de statusAtk failed: weaponAtk=${result.weaponAtk}, equipAtk=${result.equipAtk}`);
    }
...
(() => {
    ...
    if (result.weaponAtk !== 100 || result.equipAtk !== 100) {
        throw new Error(`ignoreAttackerCardfix failed: expected 100, got weaponAtk=${result.weaponAtk}, equipAtk=${result.equipAtk}`);
    }
...
(() => {
    ...
    if (result.weaponAtk !== 66 || result.equipAtk !== 66) {
        throw new Error(`ignoreElementCardfix failed: expected 66, got weaponAtk=${result.weaponAtk}, equipAtk=${result.equipAtk}`);
    }
...
(() => {
    ...
    if (result.damage !== 90) {
        throw new Error(`subElement failed: expected 90, got ${result.damage}`);
    }
...
(() => {
    ...
    if (result.damage !== 90) {
        throw new Error(`subDefElement failed: expected 90, got ${result.damage}`);
    }
...
(() => {
    ...
    if (result.damage !== 90) {
        throw new Error(`subSize failed: expected 90, got ${result.damage}`);
    }
    console.log("✓ subSize");
})();
// 15. weaponSubSize
(() => {
    ...
    if (result.damage !== 90) {
        throw new Error(`weaponSubSize failed: expected 90, got ${result.damage}`);
    }
...
(() => {
    ...
    if (result.damage !== 86) {
        throw new Error(`subRace2 failed: expected 86, got ${result.damage}`);
    }
...
(() => {
    ...
    if (result.damage !== 90) {
        throw new Error(`subRace failed: expected 90, got ${result.damage}`);
    }
    console.log("✓ subRace");
})();
// 18. subClass
(() => {
    ...
    if (result.damage !== 90) {
        throw new Error(`subClass failed: expected 90, got ${result.damage}`);
    }
...
(() => {
    ...
    if (result.damage !== 90) {
        throw new Error(`defense vs attacker class failed: expected 90, got ${result.damage}`);
    }
...
(() => {
    ...
    if (result.damage !== 725) {
        throw new Error(`Ordem defensiva failed: expected 725, got ${result.damage}`);
    }
...
(() => {
    ...
    if (result.damage !== 725) {
        throw new Error(`Truncamento defensivo failed: expected 725, got ${result.damage}`);
    }
...
(() => {
    ...
    if (result.damage !== 100) {
        throw new Error(`ignoreDefenderCardfix failed: expected 100, got ${result.damage}`);
    }
...
(() => {
    ...
    if (result.damage !== 54) {
        throw new Error(`ignoreElementCardfix (defender) failed: expected 54, got ${result.damage}`);
    }
...
(() => {
    ...
    if (attackerResult.weaponAtk !== 100 || attackerResult.equipAtk !== 100) {
        throw new Error(`Combined flags (attacker) failed: expected 100, got weaponAtk=${attackerResult.weaponAtk}, equipAtk=${attackerResult.equipAtk}`);
    }
    ...
    if (defenderResult.damage !== 90) {
        throw new Error(`Combined flags (defender) failed: expected 90, got ${defenderResult.damage}`);
    }
...
(() => {
    ...
    if (result.weaponAtk !== 54 || result.equipAtk !== 54) {
        throw new Error(`Full attacker sequence failed: expected 54, got weaponAtk=${result.weaponAtk}, equipAtk=${result.equipAtk}`);
    }
...
(() => {
    ...
    if (result.damage !== 432) {
        throw new Error(`Full defender sequence failed: expected 432, got ${result.damage}`);
    }
