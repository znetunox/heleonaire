...
} from "./effectiveAttackElementResolver";


function assertEqual(
    actual: RathenaElement,
    expected: RathenaElement,
    message: string,
): void {
    if (actual !== expected) {
        throw new Error(
...
{
    const result = resolveEffectiveAttackElement(
        "Neutral",
        {},
    );
...
console.log(
    "EFFECTIVE ATTACK ELEMENT — TODOS OS TESTES PASSARAM",
);
