...
CREATE TABLE "new_characters" (
    ...
    "pow" INTEGER NOT NULL DEFAULT 1,
...
INSERT INTO "new_characters" ("accountId", "agi", "availablePoints", "availableSkillPoints", "baseExp", "classKey", "createdAt", "dex", "faction", "gold", "hp", "id", "int", "jobExp", "jobKey", "jobLevel", "level", "luk", "mapId", "maxHp", "maxMp", "mp", "name", "posX", "posY", "posZ", "str", "updatedAt", "vit") SELECT "accountId", "agi", "availablePoints", "availableSkillPoints", "baseExp", "classKey", "createdAt", "dex", "faction", "gold", "hp", "id", "int", "jobExp", "jobKey", "jobLevel", "level", "luk", "mapId", "maxHp", "maxMp", "mp", "name", "posX", "posY", "posZ", "str", "updatedAt", "vit" FROM "characters";
